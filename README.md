...
This repository is forked from [PojavLauncher iOS](https://github.com/PojavLauncherTeam/PojavLauncher_iOS), currently continued as [Amethyst Launcher](https://github.com/AngelAuraMC/Amethyst-iOS).It named PojavLauncher Remake - upgraded remake version of old PojavLauncher. This project is not officially developed and not affiliated with old PojavLauncher developers or current Amethyst Launcher developers.

This version is developed by Builetuananh1 to improve missing features and add things wanted by old PojavLauncher users and current Amethyst users.

Now you can play with an internal account that you don't need to buy a Premium Account; but I still recommend that you should spend money to purchase it.
...
1. Download an IPA of PojavLauncher in [Releases](https://github.com/Builetuananh1/PojavLauncher-iOS/releases).
2. Open the package in TrollStore using the share menu.

#### Nightly builds
*These builds can contain game-breaking bugs. Use with caution.*
1. Download an IPA build of PojavLauncher in the [Actions tab](https://github.com/Builetuananh1/PojavLauncher-iOS/actions).
...
@jkcoxson   
@Diatrus   
@Builetuananh1 - PojavLauncher's maintainer
